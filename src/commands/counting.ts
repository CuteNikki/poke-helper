        ...
        .addTextDisplayComponents(
          new TextDisplayBuilder().setContent(
            `### Counting Game Information\n${[
              ...
              `Last number message: ${currentCounting.lastNumberMessageId ? `<https://discord.com/channels/${interaction.guildId}/${currentCounting.channelId}/${currentCounting.lastNumberMessageId}>` : 'N/A'}`,
              '',
              ...
              `Highest number message: ${currentCounting.highestNumberMessageId ? `<https://discord.com/channels/${interaction.guildId}/${currentCounting.channelId}/${currentCounting.highestNumberMessageId}>` : 'N/A'}`,
            ].join('\n')}`,
          ),
        ),
    ],
